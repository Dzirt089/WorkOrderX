...
namespace WorkOrderX.EFCoreDb.Migrations
{
    ...
    [Migration("20250812084152_UpdateTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkOrderX.Domain.AggregationModels.ProcessRequests.InstrumentKind", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("InstrumentKinds", (string)null);
                });

            modelBuilder.Entity("WorkOrderX.Domain.AggregationModels.ProcessRequests.InstrumentModel", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("InstrumentModels", (string)null);
                });

            modelBuilder.Entity("WorkOrderX.Domain.AggregationModels.ProcessRequests.InstrumentType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorkOrderX.Domain.AggregationModels.ProcessRequests.InstrumentKind", b =>
                {
                    b.HasOne("WorkOrderX.Domain.AggregationModels.ProcessRequests.InstrumentType", "InstrumentType")
                        .WithMany()
            ...
            modelBuilder.Entity("WorkOrderX.Domain.AggregationModels.ProcessRequests.ProcessRequest", b =>
                {
                    ...
                    b.HasOne("WorkOrderX.Domain.AggregationModels.ProcessRequests.InstrumentKind", "InstrumentKind")
                        .WithMany()
                        .HasForeignKey("InstrumentKindId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("WorkOrderX.Domain.AggregationModels.ProcessRequests.InstrumentModel", "InstrumentModel")
                        .WithMany()
                    ...
                    b.OwnsOne("WorkOrderX.Domain.AggregationModels.ProcessRequests.Location", "Location", b1 =>
                        {
                            b1.Property<Guid>("ProcessRequestId")
                                .HasColumnType("uniqueidentifier");
