...
namespace WorkOrderX.Application.Handlers.CommandHandlers
{
	...
	public sealed class UpdateStatusDoneOrRejectedCommandHandler : IRequestHandler<UpdateStatusDoneOrRejectedCommand, bool>
	{
		...
		public UpdateStatusDoneOrRejectedCommandHandler(IProcessRequestService processRequestService, IProcessRequestRepository processRequestRepository, IReferenceDataRepository<ApplicationStatus> referenceApplicationStatus)
		{
